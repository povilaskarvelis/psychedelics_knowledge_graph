...
from pipeline.ingest.metadata_utils import extract_pmcid_from_url, split_candidates  # noqa: E402
...
def extraction_eligibility_by_doi(
    ...
    for doi, domain_rows in screening.items():
        ...
        reason = ""
        selected = True
        if clean(screening_overrides.get(doi, {}).get("decision", "")) == "exclude_out_of_scope":
            selected = False
...
def build(args: argparse.Namespace) -> dict:
    ...
    selected = sorted(new_included & eligible - processed)
        ...
        rows.append(
            {
                ...
                **decision,
                ...
                "best_pdf_url": probable[0] if probable else "",
                "pdf_url_candidates": "|".join(metadata_pdf_url_candidates(access_metadata)),
