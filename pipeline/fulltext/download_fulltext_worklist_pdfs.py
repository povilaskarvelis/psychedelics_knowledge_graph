#!/usr/bin/env python3
"""Download PDFs for the route-independent post-screen full-text worklist."""
...
from pipeline.fulltext.download_routed_pdfs import main as download_main  # noqa: E402
