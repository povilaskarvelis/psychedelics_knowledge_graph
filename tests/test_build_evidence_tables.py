...
class BuildEvidenceTablesTest(unittest.TestCase):
    ...
    def test_route_native_molecular_metadata_infers_experimental_system(self) -> None:
        cases = [
    ...
    def test_molecular_subtopics_cover_researcher_facing_families(self) -> None:
        cases = [
            ...
            ("Gut microbiome", "Relative abundance of Lachnospiraceae UCG-004", "Microbiome composition & taxa"),
            ("Gut microbiome", "Bacterial metabolic activity measured by CFDA-SE hydrolysis", "Microbial function & metabolism"),
            ("Gut microbiome", "Ammonia production during colonic fermentation", "Microbial metabolites & SCFAs"),
    ...
    def test_molecular_postprocessing_resolves_target_pathway_and_readout_kinds(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            root = Path(tmpdir)
            registry_path = root / "registry.json"
            routed_path = root / "routed_evidence_rows.json"
