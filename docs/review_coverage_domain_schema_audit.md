...
| `molecular_pathway_readout` | `10.1002/advs.202413786`; `10.1002/da.22224`; `10.1002/da.22227` | Pathway/readout category, biological process, molecular readout category, data source, model/species, tissue/sample, brain region or cellular compartment, comparator/reference, timing, dose/exposure context, direction of change, quantitative value/unit, treatment/response relationship, clinical vs preclinical system, and whether the review is mechanistic, predictive, diagnostic, or qualification-focused. |
